...
selected_folders = {'02010004', '02010005', '02020013', '02020014'}
...
layers = 3
num_classes = 2  # 几分类
train_epochs = 50  # 15 10 5 20 2 10 100
batch_size = 64  # 32
kfolds = 10  # 10 5
test_size = 0.1
...
for kfold, (train_idx, eval_idx) in enumerate(folds):
    ...
    criterion = FocalLoss(alpha=0.30, gamma=2, reduction='sum').to(device)
    # 设置每一折的最佳模型保存位置
...
report_file = f"test_report_{data_type}_{current_date}.md"
